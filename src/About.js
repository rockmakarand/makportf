...
<br/>
        ...
        <div className='pl'>
         ...
         <a href='https://play.google.com/store/apps/details?id=com.jeecounselling'><img src={img10} className="bi"></img></a>
          ...
          <div className='lmv'data-aos="fade-out">
          <a href='https://drive.google.com/file/d/1sP20pRM7BnW1LsdO8ZqL5ZUM1faPijLe/view?usp=sharing'><button style={{color:'white',borderRadius:30}}className="hiz"><h2>View Resume</h2></button>
  </a>
  <br/>
  <br/>
